...
bool World::SendWorld(ENetPeer *peer, string name) {
	if(name != "exit") {
		Packet packet;
		Utils util;
		...
		string worldFile = "Database/Worlds/" + name + ".bin";
...
void World::ApplyTileChange(int x, int y, int16_t tile, string world) {
	Utils util;
	string worldFile = "Database/Worlds/" + world + ".bin";
